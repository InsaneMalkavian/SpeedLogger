...
public class SessionResult {
    ...
    private void calcStraightLine() {
        straightLine = Geometry.StraightLine(mLocList, false);
    }

    public boolean getDownhillOK() {
        return true; //TODO
    }

    /**
     * Indicates state of results.
     * If state is invalid - results may be incorrect. That's only means results
     * are calculated and all metrics can be retrieved. However it doesn't mean
     * results pass quality criteria like downhill, straight line.
     * @return Valid or not
     */
